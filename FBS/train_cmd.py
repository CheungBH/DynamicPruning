...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=2 python main_imagenet.py --batchsize 80 --group_size 64 --budget 0.5 --model resnet50 --model_cfg hardware_2048 --mask_type fc --target_stage 2 3 --pooling_method ave --dataset-root /media/ssd0/imagenet -s exp/channel/s50_ave_stage23_g64 --load ",
    "CUDA_VISIBLE_DEVICES=2 python main_imagenet.py --batchsize 80 --group_size 32 --budget 0.5 --model resnet50 --model_cfg hardware_2048 --mask_type fc --target_stage 2 3 --pooling_method ave --dataset-root /media/ssd0/imagenet -s exp/channel/s50_ave_stage23_g32 --load ",
    "CUDA_VISIBLE_DEVICES=2 python main_imagenet.py --batchsize 80 --group_size 16 --budget 0.5 --model resnet50 --model_cfg hardware_2048 --mask_type fc --target_stage 2 3 --pooling_method ave --dataset-root /media/ssd0/imagenet -s exp/channel/s50_ave_stage23_g16 --load ",
    "CUDA_VISIBLE_DEVICES=2 python main_imagenet.py --batchsize 80 --group_size 8 --budget 0.5 --model resnet50 --model_cfg hardware_2048 --mask_type fc --target_stage 2 3 --pooling_method ave --dataset-root /media/ssd0/imagenet -s exp/channel/s50_ave_stage23_g8 --load ",
