...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --batchsize 80 --group_size 64 --budget 0.5 --model resnet50 --model_cfg hardware_2048 --mask_type fc --target_stage 2 3 --pooling_method ave --dataset-root /media/sda1/imagenet -s exp/gumbel_channel/s50_ave_stage23_g64 --load ../dynconv/weights/hardware_2048/checkpoint_best.pth",
