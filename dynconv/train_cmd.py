...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.25 --loss_args flops -s exp/spatial_channel_2048/s75_relu_flops-C_s25_max_stage23 --group_size 64 --channel_budget 0.25 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.25 --loss_args flops -s exp/spatial_channel_2048/s75_relu_flops-C_s50_max_stage23 --group_size 64 --channel_budget 0.5 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.25 --loss_args flops -s exp/spatial_channel_2048/s75_relu_flops-C_s75_max_stage23 --group_size 64 --channel_budget 0.75 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args flops -s exp/spatial_channel_2048/s50_relu_flops-C_s25_max_stage23 --group_size 64 --channel_budget 0.25 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args flops -s exp/spatial_channel_2048/s50_relu_flops-C_s75_max_stage23 --group_size 64 --channel_budget 0.75 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.75 --loss_args flops -s exp/spatial_channel_2048/s25_relu_flops-C_s25_max_stage23 --group_size 64 --channel_budget 0.25 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.75 --loss_args flops -s exp/spatial_channel_2048/s25_relu_flops-C_s50_max_stage23 --group_size 64 --channel_budget 0.5 --channel_stage 2 3",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.75 --loss_args flops -s exp/spatial_channel_2048/s251_relu_flops-C_s75_max_stage23 --group_size 64 --channel_budget 0.75 --channel_stage 2 3",
]
