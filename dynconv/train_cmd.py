...
cmds = [
    ...
    # "python main_cifar.py --model resnet32_BN -s exp/diff_mask/r32BN_s50_stat_mom_indfor --mask_type stat_mom --budget 0.5 --load exp/diff_mask/r32BN_baseline/checkpoint_best.pth",
    # "python main_cifar.py --model resnet32_BN -s exp/diff_mask/r32BN_s75_stat_mom_indfor --mask_type stat_mom --budget 0.75 --load exp/diff_mask/r32BN_baseline/checkpoint_best.pth",
    # "python main_cifar.py --model resnet32_BN -s exp/diff_mask/r32BN_s25_stat_mom_indfor --mask_type stat_mom --budget 0.25 --load exp/diff_mask/r32BN_baseline/checkpoint_best.pth",
