...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=0 python main_imagenet.py --model_args hardware_2048 --lr 0.01 --input_resolution --batchsize 72 --budget 0.75 --loss_args layer_wise -s exp/spatial_channel_2048/s75_relu-C_s75_max_stage23-layerblock --group_size 64 --channel_budget 0.75 --channel_stage 2 3",
