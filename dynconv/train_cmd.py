...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=3 python main_imagenet.py --budget -1 --model resnet50 --dataset-root /media/hkuit164/Elements1/imagenet --mask_kernel 1 --no_attention --batchsize 32 --input_resolution --mask_type none --model_cfg hardware_static_s50_bl -s exp/baseline/channel_static_s50",
