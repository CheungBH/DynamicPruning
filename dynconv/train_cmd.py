...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=3 python main_imagenet.py --model_args hardware_2048 --resolution_mask --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args layer_wise --unlimited_lower -s exp/spatial_resmask/s50_layerloss_later_resmask --layer_loss_method later_mask",
    "CUDA_VISIBLE_DEVICES=3 python main_imagenet.py --model_args hardware_2048 --resolution_mask --lr 0.01 --input_resolution --batchsize 80 --budget 0.25 --loss_args layer_wise --unlimited_lower -s exp/spatial_resmask/s50_layerloss_later_resmask --layer_loss_method later_mask",
    "CUDA_VISIBLE_DEVICES=3 python main_imagenet.py --model_args hardware_2048 --resolution_mask --lr 0.01 --input_resolution --batchsize 80 --budget 0.75 --loss_args layer_wise --unlimited_lower -s exp/spatial_resmask/s50_layerloss_later_resmask --layer_loss_method later_mask",
