...
cmds = [
    ...
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args layer_wise --unlimited_lower -s exp/spatial_channel/s50_lr0.01_relu_layerloss-C_s50_ave_stage23 --group_size 64 --channel_budget 0.5 --channel_stage 2 3 --pooling_method ave",
    "CUDA_VISIBLE_DEVICES=1 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args flops -s exp/spatial_channel/s50_lr0.01_relu_flops-C_s50_ave_stage23 --group_size 64 --channel_budget 0.5 --channel_stage 2 3 --pooling_method ave",
    "CUDA_VISIBLE_DEVICES=2 python main_imagenet.py --model_args hardware_resnet50 --lr 0.01 --input_resolution --batchsize 80 --budget 0.5 --loss_args layer_wise --unlimited_lower -s exp/spatial_channel/s50_lr0.01_relu_layerloss_front-C_s50_ave_stage23 --layer_loss_method front_mask --group_size 64 --channel_budget 0.5 --channel_stage 2 3 --pooling_method ave",
